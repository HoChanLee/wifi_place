	...
	<form action="bookmark-delete-submit.jsp" method="post" accept-charset="UTF-8">
		...
		<table id="customers">
			<tbody>
				<tr>
					<th>북마크 이름</th>
					<td><input type="text" name="name" value="<%= dbArr[0] %>" readonly></td>
				</tr>
				<tr>
					<th>와이파이명</th>
					<td><input type="text" name="X_SWIFI_MAIN_NM" value="<%= dbArr[1] %>" readonly></td>
				</tr>
			</tbody>
		</table>
		<a href="bookmark-list.jsp">뒤로가기</a><button type="submit">삭제</button>
	</form>
</body>
</html>